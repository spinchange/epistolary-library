...
- French heading: `LETTRE IX.`
- French title line: `LE PREMIER EUNUQUE A IBBI.`
- English canonical heading: `Letter IX.`
- English title line: `The Chief Eunuch to Ibbi , 1 at Erzeroum.`
- English heading match type: `exact`
- English OCR heading source: `Letter IX.`
- Alignment key: letter number `9` / Roman numeral `IX`
