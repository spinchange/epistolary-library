...
- French heading: `LETTRE CV.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CV.`
- English title line: `TJSBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CV.`
- Alignment key: letter number `105` / Roman numeral `CV`
