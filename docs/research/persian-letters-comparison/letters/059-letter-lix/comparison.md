# Letter LIX comparison scaffold
...
- French heading: `LETTRE LIX.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter LIX.`
- English title line: `Rica to Usbek, at * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter LIX.`
- Alignment key: letter number `59` / Roman numeral `LIX`
