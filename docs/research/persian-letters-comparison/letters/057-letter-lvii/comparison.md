# Letter LVII comparison scaffold
...
- French heading: `LETTRE LVII.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter LVII.`
- English title line: `USBEK TO RheDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter L VII.`
- Alignment key: letter number `57` / Roman numeral `LVII`
