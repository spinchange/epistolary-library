# Letter CII comparison scaffold
...
- French heading: `LETTRE CII.`
- French title line: `USBEK A ***.`
- English canonical heading: `Letter CII.`
- English title line: `USBEK TO * * *`
- English heading match type: `exact`
- English OCR heading source: `Letter CIL`
- Alignment key: letter number `102` / Roman numeral `CII`
