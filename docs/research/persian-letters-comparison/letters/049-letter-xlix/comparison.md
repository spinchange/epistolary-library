# Letter XLIX comparison scaffold
...
- French heading: `LETTRE XLIX.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter XLIX.`
- English title line: `Rica to Usbek, at * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter XLIX.`
- Alignment key: letter number `49` / Roman numeral `XLIX`
