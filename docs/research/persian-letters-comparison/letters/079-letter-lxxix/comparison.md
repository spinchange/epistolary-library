# Letter LXXIX comparison scaffold
...
- French heading: `LETTRE LXXIX.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter LXXIX.`
- English title line: `XJSBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter LXXIX.`
- Alignment key: letter number `79` / Roman numeral `LXXIX`
