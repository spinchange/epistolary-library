# Letter XVII comparison scaffold
...
- French heading: `LETTRE XVII.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter XVII.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter XVII.`
- Alignment key: letter number `17` / Roman numeral `XVII`
