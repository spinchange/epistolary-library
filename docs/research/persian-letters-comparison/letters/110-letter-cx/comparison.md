...
- French heading: `LETTRE CX.`
- French title line: `RICA A ***.`
- English canonical heading: `Letter CX.`
- English title line: `Rica to * * *`
- English heading match type: `exact`
- English OCR heading source: `Letter CX.`
- Alignment key: letter number `110` / Roman numeral `CX`
