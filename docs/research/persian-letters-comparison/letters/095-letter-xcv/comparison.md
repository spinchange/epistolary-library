# Letter XCV comparison scaffold
...
- French heading: `LETTRE XCV`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter XCV.`
- English title line: `USBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter XCV.`
- Alignment key: letter number `95` / Roman numeral `XCV`
