# Letter XXXV comparison scaffold
...
- French heading: `LETTRE XXXV.`
- French title line: `USBEK A GEMCHID, SON COUSIN,`
- English canonical heading: `Letter XXXV.`
- English title line: `USBEK TO GEMCHID, HIS COUSIN, DERVISH OF THE`
- English heading match type: `exact`
- English OCR heading source: `Letter XXXV.`
- Alignment key: letter number `35` / Roman numeral `XXXV`
