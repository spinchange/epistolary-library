# Letter CXIII comparison scaffold
...
- French heading: `LETTRE CXIII.`
- French title line: `RHÉDI A USBEK.`
- English canonical heading: `Letter CXIII.`
- English title line: `Rhedi to Usbek, at Paris.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXIII.`
- Alignment key: letter number `113` / Roman numeral `CXIII`
