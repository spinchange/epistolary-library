# Letter III comparison scaffold
...
- French heading: `LETTRE III.`
- French title line: `ZACHI A USBEK.`
- English canonical heading: `Letter III.`
- English title line: `Zachi to Usbek, at Tauris.`
- English heading match type: `exact`
- English OCR heading source: `Letter III.`
- Alignment key: letter number `3` / Roman numeral `III`
