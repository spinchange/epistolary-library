# Letter CIV comparison scaffold
...
- French heading: `LETTRE CIV.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CIV.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CIV.`
- Alignment key: letter number `104` / Roman numeral `CIV`
