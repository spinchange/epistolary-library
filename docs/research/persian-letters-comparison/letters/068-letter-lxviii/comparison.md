# Letter LXVIII comparison scaffold
...
- French heading: `LETTRE LXVIII.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter LXVIII.`
- English title line: `Rica to Usbek, at * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter LX VIII.`
- Alignment key: letter number `68` / Roman numeral `LXVIII`
