# Letter XCIII comparison scaffold
...
- French heading: `LETTRE XCIII.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter XCIII.`
- English title line: `USBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter XCIII.`
- Alignment key: letter number `93` / Roman numeral `XCIII`
