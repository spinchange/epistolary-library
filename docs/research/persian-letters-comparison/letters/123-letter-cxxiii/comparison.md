# Letter CXXIII comparison scaffold
...
- French heading: `LETTRE CXXIII.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CXXIII.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXXIII.`
- Alignment key: letter number `123` / Roman numeral `CXXIII`
