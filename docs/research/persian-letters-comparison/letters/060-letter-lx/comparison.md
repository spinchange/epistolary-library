...
- French heading: `LETTRE LX.`
- French title line: `USBEK A IBBEN.`
- English canonical heading: `Letter LX.`
- English title line: `USBEK TO IBBEN, AT SMYRNA.`
- English heading match type: `exact`
- English OCR heading source: `Letter LX.`
- Alignment key: letter number `60` / Roman numeral `LX`
