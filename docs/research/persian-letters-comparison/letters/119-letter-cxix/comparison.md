# Letter CXIX comparison scaffold
...
- French heading: `LETTRE CXIX.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CXIX.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXIX.`
- Alignment key: letter number `119` / Roman numeral `CXIX`
