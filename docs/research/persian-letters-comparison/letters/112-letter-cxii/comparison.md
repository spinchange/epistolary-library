# Letter CXII comparison scaffold
...
- French heading: `LETTRE CXII.`
- French title line: `USBEK A ***.`
- English canonical heading: `Letter CXII.`
- English title line: `USBEK TO * * *`
- English heading match type: `exact`
- English OCR heading source: `Letter CXII . 1`
- Alignment key: letter number `112` / Roman numeral `CXII`
