...
- French heading: `LETTRE IV.`
- French title line: `ZÉPHIS A USBEK.`
- English canonical heading: `Letter IV.`
- English title line: `Zephis to Usbek, at Erzeroum.`
- English heading match type: `exact`
- English OCR heading source: `Letter IV.`
- Alignment key: letter number `4` / Roman numeral `IV`
