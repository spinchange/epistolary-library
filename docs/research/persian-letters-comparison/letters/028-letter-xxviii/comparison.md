# Letter XXVIII comparison scaffold
...
- French heading: `LETTRE XXVIII.`
- French title line: `RICA A ***.`
- English canonical heading: `Letter XXVIII.`
- English title line: `Rica to * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter XXVIII.`
- Alignment key: letter number `28` / Roman numeral `XXVIII`
