# Letter CXLII comparison scaffold
...
- French heading: `LETTRE CXLII.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter CXLII.`
- English title line: `Rica to Usbek, at * # *`
- English heading match type: `exact`
- English OCR heading source: `Letter CXLII.`
- Alignment key: letter number `142` / Roman numeral `CXLII`
