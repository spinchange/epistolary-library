# Letter XIII comparison scaffold
...
- French heading: `LETTRE XIII.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter XIII.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter XIII.`
- Alignment key: letter number `13` / Roman numeral `XIII`
