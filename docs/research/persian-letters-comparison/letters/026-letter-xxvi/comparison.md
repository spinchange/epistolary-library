# Letter XXVI comparison scaffold
...
- French heading: `LETTRE XXVI.`
- French title line: `USBEK A ROXANE.`
- English canonical heading: `Letter XXVI.`
- English title line: `Usbek to Roxana, at the Seraglio at Ispahan.`
- English heading match type: `exact`
- English OCR heading source: `Letter XXVI.`
- Alignment key: letter number `26` / Roman numeral `XXVI`
