# Letter CLX comparison scaffold
...
- French heading: `LETTRE CLX.`
- French title line: `SOLIM A USBEK.`
- English canonical heading: `Letter CLX.`
- English title line: `SoLIM TO USBEK, AT PARIS.`
- English heading match type: `exact`
- English OCR heading source: `Letter CLX . 1`
- Alignment key: letter number `160` / Roman numeral `CLX`
