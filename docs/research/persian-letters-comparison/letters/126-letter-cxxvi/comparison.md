# Letter CXXVI comparison scaffold
...
- French heading: `LETTRE CXXVI.`
- French title line: `RICA A ***.`
- English canonical heading: `Letter CXXVI.`
- English title line: ``
- English heading match type: `exact`
- English OCR heading source: `LETTER CXXVI.`
- Alignment key: letter number `126` / Roman numeral `CXXVI`
