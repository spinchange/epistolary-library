# Letter CXX comparison scaffold
...
- French heading: `LETTRE CXX.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CXX.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXX.`
- Alignment key: letter number `120` / Roman numeral `CXX`
