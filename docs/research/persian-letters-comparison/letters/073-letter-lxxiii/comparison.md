# Letter LXXIII comparison scaffold
...
- French heading: `LETTRE LXXIII.`
- French title line: `RICA A ***.`
- English canonical heading: `Letter LXXIII.`
- English title line: `Rica to * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter LXXIII.`
- Alignment key: letter number `73` / Roman numeral `LXXIII`
