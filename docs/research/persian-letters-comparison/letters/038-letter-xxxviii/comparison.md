# Letter XXXVIII comparison scaffold
...
- French heading: `LETTRE XXXVIII.`
- French title line: `RICA A IBBEN.`
- English canonical heading: `Letter XXXVIII.`
- English title line: `Rica to Ibben, at Smyrna.`
- English heading match type: `exact`
- English OCR heading source: `Letter XXXVIII.`
- Alignment key: letter number `38` / Roman numeral `XXXVIII`
