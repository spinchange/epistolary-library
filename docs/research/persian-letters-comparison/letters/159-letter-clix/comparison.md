# Letter CLIX comparison scaffold
...
- French heading: `LETTRE CLIX.`
- French title line: `SOLIM A USBEK.`
- English canonical heading: `Letter CLIX.`
- English title line: `SOLIM TO USBEK, AT PARIS.`
- English heading match type: `exact`
- English OCR heading source: `Letter CLIX.`
- Alignment key: letter number `159` / Roman numeral `CLIX`
