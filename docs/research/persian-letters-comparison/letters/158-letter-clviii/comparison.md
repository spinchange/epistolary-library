# Letter CLVIII comparison scaffold
...
- French heading: `LETTRE CLVIII.`
- French title line: `ZÉLIS A USBEK.`
- English canonical heading: `Letter CLVIII.`
- English title line: `Zelis to Usbek, at Paris.`
- English heading match type: `exact`
- English OCR heading source: `Letter CL VIII`
- Alignment key: letter number `158` / Roman numeral `CLVIII`
