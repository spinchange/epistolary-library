# Letter CXXXIII comparison scaffold
...
- French heading: `LETTRE CXXXIII.`
- French title line: `RICA A ***.`
- English canonical heading: `Letter CXXXIII.`
- English title line: `Rica to * * *`
- English heading match type: `exact`
- English OCR heading source: `Letter CXXXIII.`
- Alignment key: letter number `133` / Roman numeral `CXXXIII`
