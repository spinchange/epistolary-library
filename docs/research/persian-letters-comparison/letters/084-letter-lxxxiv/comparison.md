# Letter LXXXIV comparison scaffold
...
- French heading: `LETTRE LXXXIV.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter LXXXIV.`
- English title line: `USBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter LXXXIV.`
- Alignment key: letter number `84` / Roman numeral `LXXXIV`
