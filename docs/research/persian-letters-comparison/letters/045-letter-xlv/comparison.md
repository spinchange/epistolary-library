# Letter XLV comparison scaffold
...
- French heading: `LETTRE XLV.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter XLV.`
- English title line: `Rica to Usbek, at # * *`
- English heading match type: `exact`
- English OCR heading source: `Letter XL V.`
- Alignment key: letter number `45` / Roman numeral `XLV`
