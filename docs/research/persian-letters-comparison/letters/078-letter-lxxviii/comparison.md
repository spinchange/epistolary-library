# Letter LXXVIII comparison scaffold
...
- French heading: `LETTRE LXXVIII.`
- French title line: `RICA A USBEK.`
- English canonical heading: `Letter LXXVIII.`
- English title line: `Rica to Usbek, at * # *.`
- English heading match type: `exact`
- English OCR heading source: `Letter L XX VIII.`
- Alignment key: letter number `78` / Roman numeral `LXXVIII`
