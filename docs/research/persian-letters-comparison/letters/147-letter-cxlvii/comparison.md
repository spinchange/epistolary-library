# Letter CXLVII comparison scaffold
...
- French heading: `LETTRE CXLVII.`
- French title line: `LE GRAND EUNUQUE A USBEK.`
- English canonical heading: `Letter CXLVII.`
- English title line: `The Chief Eunuch to Usbek, at Paris.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXL VII.`
- Alignment key: letter number `147` / Roman numeral `CXLVII`
