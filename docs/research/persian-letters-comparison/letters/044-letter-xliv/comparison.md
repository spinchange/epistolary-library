# Letter XLIV comparison scaffold
...
- French heading: `LETTRE XLIV.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter XLIV.`
- English title line: `USBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter XLIV.`
- Alignment key: letter number `44` / Roman numeral `XLIV`
