...
- French heading: `LETTRE II.`
- French title line: `USBEK AU PREMIER EUNUQUE NOIR.`
- English canonical heading: `Letter II.`
- English title line: `USBEK TO THE CHIEF BLACK EUNUCH, AT HIS Seraglio in Ispahan.`
- English heading match type: `exact`
- English OCR heading source: `Letter II.`
- Alignment key: letter number `2` / Roman numeral `II`
