...
- French heading: `LETTRE CI.`
- French title line: `RICA AU MÊME.`
- English canonical heading: `Letter CI.`
- English title line: `Rica to the Same.`
- English heading match type: `exact`
- English OCR heading source: `Letter CI.`
- Alignment key: letter number `101` / Roman numeral `CI`
