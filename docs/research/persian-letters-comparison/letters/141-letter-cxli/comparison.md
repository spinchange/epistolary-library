# Letter CXLI comparison scaffold
...
- French heading: `LETTRE CXLI.`
- French title line: `RICA AU MÊME.`
- English canonical heading: `Letter CXLI.`
- English title line: `Rica to the Same, at * * *.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXLI.`
- Alignment key: letter number `141` / Roman numeral `CXLI`
