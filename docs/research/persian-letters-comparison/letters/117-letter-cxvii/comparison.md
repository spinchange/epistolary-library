# Letter CXVII comparison scaffold
...
- French heading: `LETTRE CXVII.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter CXVII.`
- English title line: `USBEK TO THE SAME.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXVII.`
- Alignment key: letter number `117` / Roman numeral `CXVII`
