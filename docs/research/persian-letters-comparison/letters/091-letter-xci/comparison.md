# Letter XCI comparison scaffold
...
- French heading: `LETTRE XCI.`
- French title line: `USBEK AU MÊME.`
- English canonical heading: `Letter XCI.`
- English title line: `USBEK TO THE SAME, AT SMYRNA.`
- English heading match type: `exact`
- English OCR heading source: `Letter XCI.`
- Alignment key: letter number `91` / Roman numeral `XCI`
