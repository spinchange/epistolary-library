# Letter CXXXV comparison scaffold
...
- French heading: `LETTRE CXXXV.`
- French title line: `RICA AU MÊME.`
- English canonical heading: `Letter CXXXV.`
- English title line: `Rica to the Same.`
- English heading match type: `exact`
- English OCR heading source: `Letter CXXXV.`
- Alignment key: letter number `135` / Roman numeral `CXXXV`
