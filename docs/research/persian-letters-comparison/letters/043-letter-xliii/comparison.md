# Letter XLIII comparison scaffold
...
- French heading: `LETTRE XLIII.`
- French title line: `USBEK A PHARAN.`
- English canonical heading: `Letter XLIII.`
- English title line: `USBEK TO PHARAN, AT THE GARDENS OF FATME.`
- English heading match type: `exact`
- English OCR heading source: `Letter XLIII.`
- Alignment key: letter number `43` / Roman numeral `XLIII`
