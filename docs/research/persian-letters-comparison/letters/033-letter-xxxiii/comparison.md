# Letter XXXIII comparison scaffold
...
- French heading: `LETTRE XXXIII.`
- French title line: `USBEK A RHÉDI.`
- English canonical heading: `Letter XXXIII.`
- English title line: `USBEK TO RHEDI, AT VENICE.`
- English heading match type: `exact`
- English OCR heading source: `Letter XXXIII.`
- Alignment key: letter number `33` / Roman numeral `XXXIII`
